package com.example.solarify.ui.theme
...
val BackStart = Color(0xFF0B2754)
val BackEnd = Color(0xFF1D4482)

val YellowStart = Color(0xFFC8Cf04)
val YellowEnd = Color(0xFFEFF705)